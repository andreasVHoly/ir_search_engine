...
class StopWord:
    ...
    def isStopWordLarge(self,word):
        biglist = ['a', 'a\'s', 'able','and', 'about', 'above', 'according', 'accordingly', 'across', 'actually', 'after',
                   ...
                   'into', 'inward', 'is', 'isn\'t', 'it', 'it\'d', 'it\'ll', 'it\'s', 'its', 'itself', 'j', 'just',
                   ...
                   'until', 'unto', 'up', 'upon', 'us', 'use', 'used', 'useful', 'uses', 'using', 'usually', 'uucp',
                   'v', 'value', 'various', 'very', 'via', 'viz', 'vs', 'w', 'want', 'wants', 'was', 'wasn\'t', 'way',
